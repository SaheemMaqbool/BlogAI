  ...
  return data?(
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/5 font-medium text-primary'>Saheem Maqbool</p>
      </div>
      ...
      <div className='mx-4 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        <div className='my-24 max-w-3xl mx-auto'>
           ...
           <div className='flex'>
             <img src={assets.facebook_icon} width={50} alt="fbIcon"/>
             <img src={assets.twitter_icon}  width={50} alt="twIcon" />
             <img src={assets.googleplus_icon} width={50} alt="GIcon" />
          </div>
        </div>
      </div>
